...
int main() {
    ...
    for (int razmmas = 1000; razmmas <= 100000; razmmas *= 5) {
        ...
        cout << "¬рем€ сортировки Shell случайно заполненного массива размера  " << razmmas << " = " << timee << "\n";
        ...
        cout << "¬рем€ сортировки qs случайно заполненного массива размера  " << razmmas << " = " << timee << "\n";
        ...
        timee = (double)(end - start) / CLOCKS_PER_SEC;
        cout << "¬рем€ сортировки bibl случайно заполненного массива размера  " << razmmas << " = " << timee << "\n\n";
